...
const songPlay = ()=>{
    var replaceBtn = play.innerHTML = "<i class='bx bx-pause'></i>";
    isPlaying = false;
    music.play();
    play.classList.remove(replaceBtn);
}
const songPause = ()=>{
    var replaceBtn2 = play.innerHTML = "<i class='bx bx-play'></i>";
    isPlaying = true;
    music.pause();
    play.classList.remove(replaceBtn2);
}
